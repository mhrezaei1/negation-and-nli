...
def main():
    ...
    tokenizer = tokenizer_class.from_pretrained("bert-base-uncased" if "base" in args.model_name_or_path else "bert-large-uncased", do_lower_case=args.do_lower_case)
